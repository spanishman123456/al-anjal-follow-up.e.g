...
- Verification for this change: 14 frontend suites / 93 tests pass; optimized production build passes. Local browser QA with synthetic data confirmed Arabic RTL, disabled student selection until a class is chosen, class-to-student filtering, student week coverage, all charts and zero console errors. No live student data was used.
