...
| Arabic quarter grades | `ArabicGrades.jsx` | `/40 + best theory /30 + practical /30`; Excel import targets one theory attempt only; exact-class smart maximum fill stages one column before normal save; persistent localized load failure + retry | `arabic_quarter_scores` | `/arabic/grades`, `/score-sheet/import`, Arabic exports | page + grading helper/tests + shared import control + server |
