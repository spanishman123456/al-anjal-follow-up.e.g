  ...
  return (
    <div className="space-y-8" data-testid="assessment-marks-page">
      ...
      <Card data-testid="assessment-bulk-import-card">
        <CardContent className="flex flex-wrap items-center justify-end gap-3 pt-6">
          <Button
            ...
            data-testid="assessment-download-template"
          >
            {t("download_template")}
          </Button>
          <Button
          ...
          <input
            ...
            data-testid="assessment-import-file"
          />
          <Button
            onClick={() => bulkFileInputRef.current?.click()}
            data-testid="assessment-import-excel"
          >
            {t("import_excel")}
          </Button>
        </CardContent>
      ...
      <div
        ...
        data-testid="assessment-save-banner"
      >
        <p className="text-sm text-foreground">{t("save_scores_banner")}</p>
        <Button type="button" onClick={openBulkSaveConfirm} className="shrink-0" size="lg" data-testid="assessment-bulk-save-banner">
          {t("save_all_scores")}
        </Button>
      </div>
      ...
      <Card data-testid="assessment-table-card">
        <CardContent className="pt-6">
          <Table data-testid="assessment-marks-table">
            ...
            <TableBody>
              <TableRow className="bg-muted/50" data-testid="assessment-fill-row">
                ...
                <TableCell className="text-center py-2">
                  <div className="flex items-center justify-center gap-1">
                    <Input
                      ...
                      data-testid="assessment-fill-quiz1"
                    />
                    <Button
                      type="button"
                      variant="outline"
                      ...
                      data-testid="assessment-fill-quiz1-btn"
                    >
                      {t("fill_column")}
                    </Button>
                  </div>
                ...
                <TableCell className="text-center py-2">
                  <div className="flex items-center justify-center gap-1">
                    <Input
                      ...
                      data-testid="assessment-fill-quiz2"
                    />
                    <Button
                      type="button"
                      variant="outline"
                      ...
                      data-testid="assessment-fill-quiz2-btn"
                    >
                      {t("fill_column")}
                    </Button>
                  </div>
                ...
                <TableCell className="text-center py-2">
                  <div className="flex items-center justify-center gap-1">
                    <Input
                      ...
                      data-testid="assessment-fill-practical"
                    />
                    <Button
                      type="button"
                      variant="outline"
                      ...
                      data-testid="assessment-fill-practical-btn"
                    >
                      {t("fill_column")}
                    </Button>
                  </div>
