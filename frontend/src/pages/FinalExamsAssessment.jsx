...
export default function FinalExamsAssessment() {
  ...
  return (
    <div className="space-y-8" data-testid="final-exams-assessment-page">
      ...
      <Card noHoverPop data-testid="final-exams-table-card">
                ...
                filteredStudents.map((student) => {
                  ...
                  const total =
                    !bulkEditMode && !hasPendingChanges
                      ? student.final_exams_combined_total != null &&
                        ...
                        : student.final_exams_performance_level === "no_data"
                          ? 0
                  ...
                  return (
                    <TableRow key={student.id} data-testid={`final-exams-row-${student.id}`}>
                      ...
                      <TableCell className="text-center">
                        <StudentScoreClearButton t={t} studentName={student.full_name} onClear={() => handleClearStudentScores(student)} testId={`final-exams-clear-student-${student.id}`} />
                      </TableCell>
                    </TableRow>
                  );
                })
